...
abstract class AbstractPlatformExtension extends AbstractExtension implements IPlatformExtension {
    private String mainClassExtension
    ...
    String getMainClassExtension() {
        return this.mainClassExtension
    }

    void mainClassExtension(String value) {
        this.mainClassExtension = value
    }
    ...
    Object getProp(String property, Variant variant, boolean returnDefaultIfNull) {
        if (this[property] || !returnDefaultIfNull) return this[property] else {
            ...
            switch (property) {
                ...
                case FlairProperty.MAIN_CLASS_EXTENSION.name: return "as"
                ...
                case FlairProperty.PACKAGE_TARGET.name:
                    switch (p) {
                        ...
                        case Platform.DESKTOP: return extensionManager.getFlairProperty(variant, FlairProperty.DEBUG) ? "native" : "native"
                        default: return null
                    }
